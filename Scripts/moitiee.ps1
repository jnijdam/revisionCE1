...
function New-Round {
    $maxValue = 40
    $global:number = Get-Random -Minimum 1 -Maximum $maxValue
    if ($global:number % 2 -ne 0) {
        $global:number++
    }
    $global:label.Content = "La moitié de $($global:number) est :"
    $global:textBox.Text = ""
